                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      cursorColor: Theme.of(context)
                          ...
                          .primaryColor,
                      decoration:
                          InputDecoration(labelText: localizations.salary),
                      initialValue: viewModel.userSalary.toString(),
                      validator: viewModel.validateSalary,
                      onSaved: (value) =>
                          viewModel.userSalary = int.parse(value!),
                    ),
                  ),
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: TextFormField(
                      ...
                      onSaved: (value) =>
                          viewModel.userLocationCountry = value!,
                    ),
                  ),
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                  ...
                  Padding(
                    ...
                    child: MultiSelectFormField(
                      ...
                      dataSource: List.generate(
                          ...
                          (index) => {
                                'display':
                                    viewModel.possibleUserLevelList[index],
                                'value': viewModel.possibleUserLevelList[index],
                              }),
                      textField: 'display',
                      valueField: 'value',
                      okButtonLabel: localizations.select,
                      initialValue: viewModel.userLevel == ''
                          ? []
                          : [viewModel.userLevel],
                      cancelButtonLabel: localizations.cancel,
